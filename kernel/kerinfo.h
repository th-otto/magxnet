...
struct kerinfo
{
	...
	void _cdecl (*fatal)(const char *, ...) NORETURN;
	 ...
	 */
	int	_cdecl (*denyshare)(void /* FILEPTR */ *, void /* FILEPTR */ *);
	void /* LOCK */ *	_cdecl (*denylock)(ushort pid, void /* LOCK */ *, void /* LOCK */ *);
	...
	/* 1.15 extensions */
	void /* BIO */	*bio;		/* buffered block I/O, see block_IO.doc */

	/* version 1 extension */
	void /* TIMEVAL */	*xtime;		/* pointer to current kernel time - UTC */
	...
	void	_cdecl (*load_modules)(const char *extension, long (*loader)(void /* struct basepage */ *, const char *));
