...
#if defined(__USE_MISC) || defined(__PUREC__)
/* 
...
__EXTERN int strcasecmp __PROTO(( const char *, const char * ));
__EXTERN int strncasecmp __PROTO(( const char *, const char *, size_t ));
