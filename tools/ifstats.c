...
static void slcomp_stats(unsigned long *l, char *name)
{
...
static void ether_stats(unsigned long *l, char *name)
{
	(void)l;
...
static void ppp_stats(unsigned long *l, char *name)
{
...
static void slip_stats(unsigned long *l, char *name)
{
